...
public class StockFinanceData {
    ...
    // 每股指标
    @Column(name = "eps_jb", precision = 10, scale = 4)
    private BigDecimal epsJb; // 基本每股收益

    @Column(name = "eps_kc", precision = 10, scale = 4)
    private BigDecimal epsKc; // 扣非每股收益

    @Column(name = "eps_xs", precision = 10, scale = 4)
    private BigDecimal epsXs; // 稀释每股收益

    @Column(name = "bps", precision = 10, scale = 4)
    private BigDecimal bps; // 每股净资产

    @Column(name = "mgzbgj", precision = 10, scale = 4)
    private BigDecimal mgzbgj; // 每股资本公积

    @Column(name = "mgwfplr", precision = 10, scale = 4)
    private BigDecimal mgwfplr; // 每股未分配利润

    @Column(name = "mgjyxjje", precision = 10, scale = 4)
    ...
    @Column(name = "net_profit_kc", precision = 18, scale = 2)
    ...
    @Column(name = "net_profit_yoy", precision = 10, scale = 4)
    private BigDecimal netProfitYoy; // 净利润同比增长率

    @Column(name = "net_profit_kc_yoy", precision = 10, scale = 4)
    private BigDecimal netProfitKcYoy; // 扣非净利润同比增长率

    @Column(name = "revenue_qoq", precision = 10, scale = 4)
    private BigDecimal revenueQoq; // 营收环比增长率

    @Column(name = "net_profit_qoq", precision = 10, scale = 4)
    private BigDecimal netProfitQoq; // 净利润环比增长率

    @Column(name = "net_profit_kc_qoq", precision = 10, scale = 4)
    ...
    @Column(name = "roe_kc", precision = 10, scale = 4)
    ...
    // 运营能力
    @Column(name = "cash_flow_ratio", precision = 10, scale = 4)
    ...
    @Column(name = "equity_multiplier", precision = 10, scale = 4)
    private BigDecimal equityMultiplier; // 权益乘数

    // 周转能力
    @Column(name = "total_asset_turnover", precision = 10, scale = 4)
    ...
    @Column(name = "receivable_turnover", precision = 10, scale = 4)
